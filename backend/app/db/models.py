...
class Session(Base):
    ...
    execution_timeout: Mapped[int] = mapped_column(Integer, default=60)  # seconds
    max_fix_attempts: Mapped[int] = mapped_column(Integer, default=3)
    auto_install_deps: Mapped[bool] = mapped_column(Boolean, default=True)
    agent_timeout: Mapped[int] = mapped_column(Integer, default=300)  # LLM API call timeout per agent (seconds)
